...
if(isset($_REQUEST['requpdate'])){
    ...
    if($conn -> query($sql) == TRUE){
        $msg = '<div class="alert alert-success col-sm-9 ml-5 mt-2">Cập nhật sản phẩm thành công</div>';
    }
    else{
...
<div class="col-sm-9 mx-3 jumbotron">
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="date" class="form-control" id="sp_nsx" name="sp_nsx" value ="<?php 
            if(isset($row['sp_nsx'])){
                echo $row['sp_nsx'];
            }?>" >
        </div>';
